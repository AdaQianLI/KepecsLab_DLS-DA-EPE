...
% ONLINE_NIDAQPLOT_8CLASS_470
% Online figure for the 470 nm photometry channel: raw trace for the
% current trial plus class-wise dF/F averages across trials.
global BpodSystem S
...
%% Create Figure
figPlot=figure('Name','Online Nidaq Plot_470nm','Position', [300 120 600 700], 'numbertitle','off'); %[left bottom width height]
hold on
...
allData(:,dataSize+1)=newData470(1:factor:end,3);
...
set(figData.meanplot(curTrialType), 'XData',newData470(1:factor:end,1),'YData',meanData,'LineWidth',MeanThickness);
