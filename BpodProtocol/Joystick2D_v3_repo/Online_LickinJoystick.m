...
% ONLINE_LICKINJOYSTICK
% Initialize and update the online summary figure for trial outcomes and
% lick rasters grouped by trial/result class.
...
%% Create Figure
figPlot=figure('Name','Online LickinMotor Plot','Position', [1100 120 500 700], 'numbertitle','off');
hold on
