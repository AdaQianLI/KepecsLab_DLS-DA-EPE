...
% BPOD_JOYSTICK2D_V3_PARAMETER
% Populate the Bpod GUI settings structure with default values for
% behavioral timing, force levels, photometry, sound, and online plots.
% The defaults below are meant to match the manuscript description:
% 4 s pre-cue period, 0.5 s cue, 1 s delay, 5.5 s response window, and
% a 150 ms hold requirement in the target zone.
%
%
%
...
global S
    ...
    S.Names.StateToZero={'CueDeliver','blank'};   % Event used as time zero for online alignment.
    S.Names.StateToEnd={'Break','blank'};   % Event marking the nominal end of a trial for online alignment.    
...
%     S.GUIPanels.Timing={'DelayTime','ITI'};
    ...
    S.GUI.L0Force=0; % Null-field baseline / free-reach condition.
    S.GUI.L1Force=40;
    S.GUI.L2Force=70;
    S.GUI.L3Force=70;
    S.GUI.HoldingTime=0.15; % Hold time in the target zone (s).
...
%% Online Plots   
    ...
    S.GUIPanels.PlotParameters={'StateToZero','StateToEnd','TimeMin_lick','TimeMax_lick','TimeMin_photometry','TimeMax_photometry'};
