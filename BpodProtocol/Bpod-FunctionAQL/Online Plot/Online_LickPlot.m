function figData=Online_LickPlot(action,trialSequence,trialMatrix,Phase,figData,currentTrial,outcome,trialType,newxdata)
...
% plot(10,2,'ko','MarkerSize',MS_trial,'DisplayName','reward'); %circle legend, ie reward
% plot(10,1,'ks','MarkerSize',MS_trial,'DisplayName','omission'); %square legend, ie omission
% plot(10,0.5,'kd','MarkerSize',MS_trial,'DisplayName','punish'); %diamond legend, ie Large
% plot(10,0,'ko','MarkerSize',MS_trial,'DisplayName','omission'); %green legend, ie hi
% legend (
...
xlabel('Trial Number');
set(trialsubplot,'XLim',[3-plotSpan 3+plotSpan],'YLim',[-0.5 2.5],'YTick',[0 1 2],...
                        'YTickLabel',{'Uncued','SoundA','SoundB'},'YTickLabelRotation', 45 );
...
%         if trialSequence(i)==TrialType
            trialsPlot(i)=plot(i,trialMatrix(trialSequence(i),3),'LineStyle','none','marker',char(trialMatrix(trialSequence(i),7)),'MarkerFaceColor','b', 'MarkerEdgeColor','k','MarkerSize',MS_trial);
%         end
%     end
end
hold off
...
for  j=1:ttNb
set(licksubplot(j),'XLabel',[],'YLabel',[]);
...
%% Update GUI plot parameters
        ...
        set(figData.licksubplot(trialType),'XLim',[minx maxx],'XTick',xtickvalues);
