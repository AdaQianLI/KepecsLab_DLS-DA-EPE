...
%% Create Figure
figPlot=figure('Name','Online Nidaq Plot_565nm','Position', [550 550 600 700], 'numbertitle','off'); %[left bottom width height]
hold on
...
allData(:,dataSize+1)=newData565(:,3);
...
set(figData.meanplot(curTrialType), 'XData',newData565(:,1),'YData',meanData,'LineWidth',MeanThickness);
