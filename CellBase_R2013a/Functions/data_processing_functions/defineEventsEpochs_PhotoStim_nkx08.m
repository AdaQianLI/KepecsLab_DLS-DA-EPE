function [events,epochs] = defineEventsEpochs_PhotoStim_nkx08
...
events(i,:) = {'BurstOn',       'BurstOn',         'BurstOn',         [-3 3]};    i = i + 1;
events(i,:) = {'BurstOff',      'BurstOff',        'BurstOff',        [-3 3]};    i = i + 1;

events(i,:) = {'PulseOn_chr2',       'PulseOn_chr2',         'PulseOn_chr2',         [-3 3]};    i = i + 1;
events(i,:) = {'PulseOff_chr2',      'PulseOff_chr2',        'PulseOff_chr2',        [-3 3]};    i = i + 1;
events(i,:) = {'BurstOn_chr2',       'BurstOn_chr2',         'BurstOn_chr2',         [-3 3]};    i = i + 1;
events(i,:) = {'BurstOff_chr2',      'BurstOff_chr2',        'BurstOff_chr2',        [-3 3]};    i = i + 1;

events(i,:) = {'PulseOn_arch',       'PulseOn_arch',         'PulseOn_arch',         [-3 3]};    i = i + 1;
events(i,:) = {'PulseOff_arch',      'PulseOff_arch',        'PulseOff_arch',        [-3 3]};    i = i + 1;
events(i,:) = {'BurstOn_arch',       'BurstOn_arch',         'BurstOn_arch',         [-3 3]};    i = i + 1;
events(i,:) = {'BurstOff_arch',      'BurstOff_arch',        'BurstOff_arch',        [-3 3]};    i = i + 1;
