function R= spikeshapecorr(cellid,lim1,lim2)
...
selts_evoked = extractSegSpikes(cellid,tsegs_evoked);   % find putative stimualated spikes around epochs relative to pulses
[wave_evoked,SpikeTimes_match] = extractSpikeWaveforms(cellid,selts_evoked,'chans','mean_max');  % get waveforms for the extracted spikes
selts_evoked=SpikeTimes_match;
% Spontaneous spikes
tsegs_spont = rel2abstimes(cellid,[-2 0],'stim','BurstOn');   % extract 2s periods before bursts  % 0.05 0.09
