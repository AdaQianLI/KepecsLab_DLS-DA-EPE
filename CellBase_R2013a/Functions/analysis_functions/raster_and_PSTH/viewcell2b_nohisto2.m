function r=R_spikeshape(cellid,ADBitVolts,varargin)
...
%%
         psthstat = psth_stats(cellid,binraster,spsth,'sigma',g.sigma,'dt',g.dt,'win',g.win,'plotwin',g.win_psth{1},...
        'baselinewin',[g.win{1}(1) 0],'testwin',[0.001 g.win{1}(2)],'display',1,'relative_threshold',0.2); 
    
        r= plotwaveforms2(cellid,psthstat,ADBitVolts,'event',g.TriggerName,'spon_window',[g.win(1) 0],'maxnum',5000);
end
